---
name: 游戏功能规则编写规范
description: 提供游戏功能文档中规则描述的编写规范，包含规则描述标准、逻辑细节拆分方法、系统解耦设计原则和文档简洁性规则，可独立调用以评审或优化规则描述质量。
---
...
本 skill 提供游戏功能文档中**规则描述的编写规范和最佳实践**，确保规则描述清晰、无歧义、易于理解和实现。

### 使用场景

- 被 `game_doc_generator` 主流程引用，指导规则章节的编写
- **独立调用**：评审已有文档的规则描述质量、重写/优化某段规则
